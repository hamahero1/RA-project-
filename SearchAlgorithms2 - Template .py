...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="8-puzzle solver using UCS, A*, Greedy, and a browser UI.")
    ...
    parser.add_argument("--tk", action="store_true", help="Run the optional Tkinter desktop UI.")
    ...
    parser.add_argument("--algorithm", choices=["UCS", "A*", "Greedy"], help="Run one algorithm in command-line mode.")
